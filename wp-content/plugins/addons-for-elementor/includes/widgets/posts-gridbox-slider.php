...
class LAE_Posts_GridBox_Slider_Widget extends LAE_Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control( 'arrow_style', [
            'type'    => Controls_Manager::SELECT,
            'label'   => __( 'Choose Slider Arrow Style', 'livemesh-el-addons' ),
            'options' => array(
            'style-1' => __( 'Arrow Style 1', 'livemesh-el-addons' ),
            'style-2' => __( 'Arrow Style 2', 'livemesh-el-addons' ),
            'style-3' => __( 'Arrow Style 3', 'livemesh-el-addons' ),
            'style-4' => __( 'Arrow Style 4', 'livemesh-el-addons' ),
            'style-5' => __( 'Arrow Style 5', 'livemesh-el-addons' ),
            'style-6' => __( 'Arrow Style 6', 'livemesh-el-addons' ),
            'style-7' => __( 'Arrow Style 7', 'livemesh-el-addons' ),
            'style-8' => __( 'Arrow Style 8', 'livemesh-el-addons' ),
        ),
            'default' => 'style-1',
        ] );
